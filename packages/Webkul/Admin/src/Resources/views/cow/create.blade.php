...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                        {{ __('admin::app.cow.register_description') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Form -->
        <div class="p-6">
            <form method="POST" action="{{ route('admin.cow.store') }}" enctype="multipart/form-data" class="max-w-2xl">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="health_status" 
                                ...
                                required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">
                            <option value="healthy" {{ old('health_status') == 'healthy' ? 'selected' : '' }}>
                                {{ __('admin::app.cow.healthy') }}
                            </option>
                            <option value="at-risk" {{ old('health_status') == 'at-risk' ? 'selected' : '' }}>
                                {{ __('admin::app.cow.at_risk') }}
                            </option>
                            <option value="sick" {{ old('health_status') == 'sick' ? 'selected' : '' }}>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                    <label for="photo" class="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                        <span>{{ __('admin::app.cow.upload_photo') }}</span>
